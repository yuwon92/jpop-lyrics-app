...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle('vocab:update', (_e, payload) => updateVocab(payload))
  ipcMain.handle('vocab:save-readings', (_e, entries: { id: number; reading: string }[]) =>
    saveWordReadings(entries)
  )
